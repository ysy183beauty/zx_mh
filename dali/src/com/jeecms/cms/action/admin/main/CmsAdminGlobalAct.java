...
public class CmsAdminGlobalAct extends CmsAdminAbstract {
	...
	public String list(String queryUsername, String queryEmail,
			Integer queryGroupId, Boolean queryDisabled, String queryFlag,
		...
		Pagination pagination = manager.getPage(queryUsername, queryEmail,
				...
				null,null, cpn(pageNo), CookieUtils.getPageSize(request),queryFlag);
		...
		appendQueryParam(model, queryUsername, queryEmail, queryGroupId, 
				queryDisabled,queryFlag, queryRealName, queryDepartId, queryRoleId);
	...
	public String update(CmsUser bean, CmsUserExt ext, String password,String queryFlag,
		...
		cmsLogMng.operating(request, "cmsUser.log.update", "id=" + bean.getId()
				+ ";username=" + bean.getUsername());
		return list(queryUsername, queryEmail,queryGroupId, queryDisabled,queryFlag,queryRealName,
	...
	public String delete(Integer[] ids, Integer queryGroupId,String queryFlag,
			Boolean queryDisabled,String queryRealName,Integer queryDepartId,
		...
		return list(queryUsername, queryEmail, queryGroupId, queryDisabled,queryFlag,
				queryRealName,queryDepartId,queryRoleId,
				pageNo, request, model);
	}
