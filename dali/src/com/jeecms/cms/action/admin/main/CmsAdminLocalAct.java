...
public class CmsAdminLocalAct extends CmsAdminAbstract {
	...
	public String list(String queryUsername, String queryEmail,String queryFlag,
		...
		appendQueryParam(model, queryUsername, queryEmail,queryFlag, queryGroupId,
	...
	public String update(CmsUser bean, CmsUserExt ext, String password,
			...
			Boolean queryDisabled, String queryFlag,
			String queryRealName,Integer queryDepartId,Integer queryRoleId,
			Boolean queryAllChannel,Boolean queryAllControlChannel
		...
		cmsLogMng.operating(request, "cmsUser.log.update", "id=" + bean.getId()
				+ ";username=" + bean.getUsername());
		return list(queryUsername, queryEmail, queryFlag,queryGroupId, queryDisabled,
	...
	public String delete(Integer[] ids, Integer queryGroupId,
			Boolean queryDisabled,String queryRealName,String queryFlag,
	...
	private void appendQueryParam(ModelMap model,
			String queryUsername, String queryEmail,String queryFlag,
			Integer queryGroupId, Boolean queryDisabled, 
			String queryRealName,Integer queryDepartId,Integer queryRoleId,
			Boolean queryAllChannel,Boolean queryAllControlChannel){
