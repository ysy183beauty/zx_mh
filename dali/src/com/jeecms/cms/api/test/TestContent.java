...
public class TestContent {
	...
	private static String testSaveContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/save.jspx";
	...
	private static String testUpdateContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/update.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testDelContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/del.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testRecycleContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/recycle.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"209,210");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testCheckContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/check.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"209,210,");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testRejectContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/reject.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"209,210");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testUpContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/up.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testDownContent(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/down.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"130");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testBuyContent(){
		//购买API地址
		//String url="http://192.168.0.173:8080/jeecmsv8/api/content/buy.jspx";
		//打赏API地址
		String url="http://192.168.0.173:8080/jeecmsv8/api/content/reward.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"130");
		//微信订单
	...
	public static String testUpload(String local,String type){
		String url="http://192.168.0.173:8080/jeecmsv8/api/upload/o_upload.jspx?";
	...
	private static String testUploadDoc(String local){
		String url="http://192.168.0.173:8080/jeecmsv8/api/upload/o_upload_doc.jspx?";
		FileUpload fileUpload = new FileUpload();
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		StringBuffer paramBuff=new StringBuffer();
		Map<String, String>param=new HashMap<String, String>();
