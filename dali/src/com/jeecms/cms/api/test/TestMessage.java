...
public class TestMessage {
	...
	private static String testMessageGet(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/message/get.jspx";
	...
	private static String testMessageMyList(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/message/list.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageSendOrDraft(Integer box){
		String url="http://192.168.0.173:8080/jeecmsv8/api/message/send.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageDraftUpdate(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/message/draftUpdate.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageDraftToSend(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/message/draftToSend.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+2);
		paramBuff.append("&appId="+appId);
		String encryptSessionKey="";
	...
	private static String testMessageBatchOperate(String operateType,String ids){
		...
		if (operateType=="trash") {
			url="http://192.168.0.173:8080/jeecmsv8/api/message/trash.jspx";
		}else if(operateType=="revert"){
			url="http://192.168.0.173:8080/jeecmsv8/api/message/revert.jspx";
		}else{
			url="http://192.168.0.173:8080/jeecmsv8/api/message/delete.jspx";
		}
		StringBuffer paramBuff=new StringBuffer();
