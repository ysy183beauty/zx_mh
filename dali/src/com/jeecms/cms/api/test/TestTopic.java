...
public class TestTopic {
	...
	private static String testSaveTopic(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/topic/save.jspx";
		...
		String titleImg=TestContent.testUpload("d:\\test\\load.jpg", "image");
		String contentImg=TestContent.testUpload("d:\\test\\load.jpg", "image");
	...
	private static String testUpdateTopic(){
		String url="http://192.168.0.173:8080/jeecmsv8/api/topic/update.jspx";
		StringBuffer paramBuff=new StringBuffer();
