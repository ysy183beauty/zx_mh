...
public class FrontUtils {
	...
	public static String getTplPath(HttpServletRequest request,
		...
		if(StringUtils.isNotBlank(equipment)&&equipment.equals("mobile")){
			...
			if(agent!=null&& agent.contains("micromessenger")){//微信公众号登录
				solution=site.getMobileSolutionPath();
			}
		}
		String urlIdex=solution + "/" + dir + "/"+ MessageResolver.getMessage(request, name) + TPL_SUFFIX;
		System.out.println(urlIdex);
		return solution + "/" + dir + "/"
	...
	public static String showMessage(HttpServletRequest request,
		...
		return getTplPath(request, site.getSolutionPath(), TPLDIR_ALONE,MESSAGE_PAGE);
	}
