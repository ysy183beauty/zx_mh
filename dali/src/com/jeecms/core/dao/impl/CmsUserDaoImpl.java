...
public class CmsUserDaoImpl extends HibernateBaseDao<CmsUser, Integer>
    ...
    public Pagination getPage(String username, String email, Integer siteId,
        ...
        if (queryFlag != null && !"".equals(queryFlag) && !"全部".equals(queryFlag)) {
            if ("1".equals(queryFlag)) {
                f.append(" and ext.flag is null");
            } else {
                f.append(" and ext.flag=:flag");
                f.setParam("flag", queryFlag);
            }
    ...
    public int countByMobile(String mobile) {
        String hql = "select count(*) from CmsUser bean join bean.userExtSet ext where ext.mobile=:mobile";
        Query query = getSession().createQuery(hql);
