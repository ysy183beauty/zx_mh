...
public class LoginAct {
	...
	public static final String LOGIN_INPUT = "/WEB-INF/t/cms/www/red/alone/单页_信用大理_用户登录.html";//"/WEB-INF/t/jeecore/login.html";
	...
	public String input(HttpServletRequest request, ModelMap model) {
		...
		String weixinmsg=RequestUtils.getQueryParam(request,"weixinmsg");
